        ...
        <div key={chabi} className=" w-[400px] h-[650px]  bg-white  flex flex-col items-center ">
          <div className="img w-[150px] h-[220px]  ">
             <img src={apibox.image} alt="photo" />
              ...
              <button onClick={()=>next(apibox)} className='bg-black rounded-[5px] text-white active:scale-125 p-3 hover:border-[2px] hover:border-[#000] hover:bg-transparent transition-all hover:text-[#000]' > BUY NOW </button>
